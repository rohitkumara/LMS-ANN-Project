...
def l_plotting(train_data, test_data):
	...
	for tick in ax.yaxis.get_major_ticks():
		tick.label.set_fontsize(20)
	#plt.show()
	plt.savefig('plots_rnn/snrvslrl_code.png')
	with open('plots_rnn/snrvslrl_code.pkl', "wb") as fp:
		pickle.dump(fig, fp, protocol=4)
	with open('plots_rnn/snrvslrl_list.pkl', "wb") as fp:
		pickle.dump(train_data, fp)
		pickle.dump(test_data, fp)

for i in range(len(lr)):
	filter = RNNFilter('Mockingbird.wav', epoch = 10, lr = lr[i])
...
def h_plotting(train_data, test_data):
	...
	for tick in ax.yaxis.get_major_ticks():
		tick.label.set_fontsize(20)
	#plt.show()
	plt.savefig('plots_rnn/snrvslrh_code.png')
	with open('plots_rnn/snrvslrh_code.pkl', "wb") as fp:
		pickle.dump(fig, fp, protocol=4)
	with open('plots_rnn/snrvslrh_list.pkl', "wb") as fp:
		pickle.dump(train_data, fp)
		pickle.dump(test_data, fp)
...
def fl_plotting(train_data, test_data):
	...
	for tick in ax.yaxis.get_major_ticks():
		tick.label.set_fontsize(20)
	#plt.show()
	plt.savefig('plots_rnn/snrvsfl_code.png')
	with open('plots_rnn/snrvsfl_code.pkl', "wb") as fp:
		pickle.dump(fig, fp, protocol=4)
	with open('plots_rnn/snrvsfl_list.pkl', "wb") as fp:
		pickle.dump(train_data, fp)
		pickle.dump(test_data, fp)

for i in range(len(fl)):
	filter = RNNFilter('Mockingbird.wav', epoch = 10, tap = fl[i])
